...
// 色卡数据源：HansBug/pindou-color-data (CC BY 4.0)
//
//   node ios/scripts/gen-palettes.mjs
//
// 产物：ios/BeadPattern/BeadPattern/Resources/Palettes.json
...
const out = resolve(here, '../BeadPattern/BeadPattern/Resources/Palettes.json');
